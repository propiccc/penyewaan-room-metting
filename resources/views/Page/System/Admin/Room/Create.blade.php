...
<div class="bg-white text-white w-full rounded-lg p-8 shadow-lg shadow-gray-600">
    ...
    <div class="flex justify-between items-center">
        <span class="text-xl font-semibold text-black">Room Create</span>
    </div>
        ...
        <form action="{{route('room.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex flex-col gap-x-2">
                <div class="flex flex-col w-full">
                    ...
                    <input id="name" type="text" name="room_name" class= "bg-white text-black p-2 border-[2px] border-gray-500 rounded-md" autocomplete="off" required>
                ...
                <div class="flex flex-col w-full">
                    ...
                    <input class="p-2 border-[2px] border-gray-500 bg-white text-black rounded-md" type="number" name="capacity" id="capacity" placeholder="10" autocomplete="off" required>
